...
Use this skill for photoreal subjects with tiny black-line doodle people. The real subjects retain photographic material and identity; the added figures provide the micro-story. For the same subject redrawn entirely in black crayon, charcoal, or dry brush, use the separate `silas-photo-to-ink-diptych` skill. These are independent skills, not modes or versions of each other.
